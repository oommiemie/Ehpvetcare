import svgPaths from "./svg-pn35hiuamf";
...
function Div4() {
  return (
    <div className="relative shrink-0 w-full" data-name="div">
      <div className="content-stretch flex flex-col gap-[16px] items-start not-italic px-[8px] py-[16px] relative text-[12px] w-full whitespace-nowrap">
        <Container7 />
        <Container8 />
        <Container9 />
        <Container10 />
...
export default function ContainerVariant() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[10px] items-center justify-center p-[8px] relative size-full" data-name="Container/Variant3">
      <Frame />
      <Div4 />
      <Frame1 />
    </div>
