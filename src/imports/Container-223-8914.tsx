import svgPaths from "./svg-7usflk4bo2";
...
export default function Container() {
  return (
    <div className="relative size-full" data-name="Container" style={{ backgroundImage: "linear-gradient(176.455deg, rgb(25, 165, 137) 0%, rgb(13, 124, 102) 100%), linear-gradient(90deg, rgba(249, 250, 251, 0.6) 0%, rgba(249, 250, 251, 0.6) 100%)" }}>
      <div className="content-stretch flex gap-[11.999px] items-center pb-[24.633px] pt-[24px] px-[23.999px] relative size-full">
        <Container1 />
        <div className="absolute bottom-[-12px] right-[-0.28px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.1)] size-[150px]" data-name="image 19">
          <img alt="" className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 max-w-none object-cover opacity-70 pointer-events-none size-full" src={imgImage19} />
        </div>
      </div>
