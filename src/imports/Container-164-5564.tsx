import svgPaths from "./svg-fuy2lht0km";

function DoorLeftHandClosed() {
  return (
    <div className="h-[20.732px] relative shrink-0 w-[15.244px]" data-name="door.left.hand.closed 1">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid overflow-clip relative rounded-[inherit] size-full">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.2441 20.7324">
          <g id="Group">
            <path d={svgPaths.p2fdb5a80} fill="var(--fill-0, white)" id="Vector" opacity="0" />
            <path d={svgPaths.p38336980} fill="var(--fill-0, white)" id="Vector_2" />
            <path d={svgPaths.p3e0b9400} fill="var(--fill-0, white)" id="Vector_3" />
          </g>
        </svg>
      </div>
    </div>
    ...
    <div className="relative rounded-[12px] shrink-0 w-full" data-name="RoomsTab" style={{ backgroundImage: "linear-gradient(139.123deg, rgba(172, 255, 238, 0.2) 0%, rgba(220, 255, 248, 0.2) 100%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%)" }}>
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col gap-[8px] items-center px-[14px] py-[12px] relative w-full">
          ...
          <p className="font-['IBM_Plex_Sans_Thai_Looped:Medium',sans-serif] leading-[15px] not-italic relative shrink-0 text-[#99a1af] text-[10px] text-center whitespace-nowrap">ห้องธรรมดา</p>
          <Text />
        </div>
      </div>
    </div>
