import svgPaths from "./svg-iulxc5nl6z";
...
function ContainerVariant() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-center justify-center overflow-clip p-[8px] relative rounded-bl-[16px] rounded-br-[16px] shrink-0 w-[320px]" data-name="Container/Variant3" style={{ backgroundImage: "linear-gradient(90deg, rgb(249, 250, 251) 0%, rgb(249, 250, 251) 100%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%)" }}>
      <Frame />
      <Div4 />
      <Frame1 />
    </div>
