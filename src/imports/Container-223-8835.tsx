import svgPaths from "./svg-dtobv8t00r";
...
function Text() {
  return (
    <div className="h-[19.993px] relative shrink-0 w-[89.576px]" data-name="Text">
      <p className="absolute font-['IBM_Plex_Sans_Thai_Looped:Bold',sans-serif] leading-[20px] left-0 not-italic text-[14px] text-white top-[0.1px] whitespace-nowrap">ทะเบียนพันธุ์สัตว์</p>
    </div>
  );
}
...
function Text1() {
  return (
    <div className="h-[15.996px] relative shrink-0 w-[88.487px]" data-name="Text">
      <p className="absolute font-['IBM_Plex_Sans_Thai_Looped:Regular',sans-serif] leading-[16px] left-0 not-italic text-[12px] text-[rgba(255,255,255,0.7)] top-[0.1px] whitespace-nowrap">Breed Registry</p>
    </div>
  );
}
  ...
  return (
    <div className="bg-white relative rounded-[21243700px] shrink-0" data-name="Button">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-px items-center px-[16px] py-[8px] relative">
        <Icon1 />
        <p className="font-['IBM_Plex_Sans_Thai_Looped:SemiBold',sans-serif] leading-[16px] not-italic relative shrink-0 text-[#e8802a] text-[12px] text-center whitespace-nowrap">เพิ่มพันธ์ุ</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="relative size-full" data-name="Container" style={{ backgroundImage: "linear-gradient(174.852deg, rgb(139, 92, 246) 0%, rgba(124, 58, 237, 0.5) 100%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%)" }}>
      <div className="content-stretch flex gap-[11.999px] items-center pb-[24.633px] pt-[24px] px-[23.999px] relative size-full">
        <div className="absolute h-[149px] right-[-20px] top-[-60px] w-[150px]" data-name="Pet">
          <div className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 opacity-70 overflow-hidden pointer-events-none">
