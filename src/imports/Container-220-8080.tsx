import svgPaths from "./svg-moblrm1ucj";
import imgImage17 from "figma:asset/2d18f6929a57bb9f599514b4d247d99a664978ee.png";
...
function Text() {
  return (
    <div className="h-[19.993px] relative shrink-0 w-[112.269px]" data-name="Text">
...
function Text1() {
  return (
    <div className="h-[15.996px] relative shrink-0 w-[86.271px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function Button() {
  return (
    <div className="relative rounded-[21243700px] shrink-0" data-name="Button" style={{ backgroundImage: "linear-gradient(163.05deg, rgb(232, 128, 42) 0%, rgb(208, 106, 26) 100%)" }}>
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-px items-center px-[16px] py-[8px] relative">
        <Icon1 />
        <p className="font-['IBM_Plex_Sans_Thai_Looped:SemiBold',sans-serif] leading-[16px] not-italic relative shrink-0 text-[12px] text-center text-white whitespace-nowrap">เพิ่มบริการ</p>
      </div>
    </div>
  );
}
...
export default function Container() {
  return (
    <div className="relative size-full" data-name="Container" style={{ backgroundImage: "linear-gradient(174.998deg, rgb(232, 128, 42) 0%, rgb(208, 106, 26) 100%)" }}>
      <div className="content-stretch flex gap-[11.999px] items-center pb-[24.633px] pt-[24px] px-[23.999px] relative size-full">
        <div className="absolute right-[-0.02px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.1)] size-[100px] top-[-16.32px]" data-name="image 17">
          <div className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 overflow-hidden pointer-events-none">
            <img alt="" className="absolute left-[-18.6%] max-w-none size-[142%] top-[-20.99%]" src={imgImage17} />
          </div>
        </div>
        <Container1 />
        <Button />
