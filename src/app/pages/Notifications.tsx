...
const notifications: Notification[] = [
  ...
  { id: 5, type: "boarding", title: "ถึงกำหนดรับสัตว์เลี้ยงวันนี้", body: "ร็อคกี้ (HN-2026-002) บริการฝากเลี้ยงสิ้นสุดวันนี้เวลา 17:00 น. เจ้าของ: สมศักดิ์ ใจดี ควรได้รับการแจ้ง", time: "3 ชั่วโมงที่แล้ว", read: true, urgent: false, petName: "ร็อคกี้", owner: "สมศักดิ์ ใจดี" },
  ...
  { id: 7, type: "appointment", title: "บันทึกขาดนัด", body: "เบลล่า (HN-2026-004) ไม่มาตามนัดเวลา 11:30 น. เจ้าของ: ปรียาภรณ์ ทองดี", time: "6 ชั่วโมงที่แล้ว", read: true, urgent: false, petName: "เบลล่า", owner: "ปรียาภรณ์ ทองดี" },
  ...
  { id: 9, type: "vaccine", title: "วัคซีนครบกำหนด — โมจิ", body: "โมจิ (HN-2026-012) ครบกำหนดฉีด FVRCP วันที่ 15 มีนาคม 2026", time: "เมื่อวาน", read: true, urgent: false, petName: "โมจิ", owner: "ประพันธ์ มงคล" },
