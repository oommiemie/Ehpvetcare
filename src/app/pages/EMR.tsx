    ...
    visits: [
      {
        ...
        vitals: { temp: "39.4°C", pulse: "110 bpm", resp: "28 ครั้ง/นาที", weight: "28.5 กก.", chiefComplaint: "ซึม เบื่ออาหาร", presentIllness: "เจ้าของแจ้งว่าน้องไม่กินอาหาร 2 วัน มีอาการซึมลง มีไข้เล็กน้อย ไม่ไอ ไม่จาม ถ่ายปกติ" },
      ...
      },
      {
        ...
        room: "ห้อง 1 — ทั่วไป", doctor: "สพ.ว. สมชาย",
        vitals: { temp: "38.6°C", pulse: "98 bpm", resp: "22 ครั้ง/นาที", weight: "28.0 กก.", chiefComplaint: "มาฉีดวัคซีนประจำปี", presentIllness: "สุขภาพดี กินอาหารปกติ ร่าเริง" },
      ...
      },
      {
        ...
        vitals: { temp: "38.8°C", pulse: "105 bpm", resp: "24 ครั้ง/นาที", weight: "27.8 กก.", chiefComplaint: "ท้องเสีย อาเจียน 1 วัน", presentIllness: "กินอาหารผิดปกติ (กระดูกไก่) แล้วอาเจียนและถ่ายเหลว" },
    ...
    visits: [
      {
        ...
        vitals: { temp: "38.5°C", pulse: "180 bpm", resp: "30 ครั้ง/นาที", weight: "4.2 กก.", chiefComplaint: "ตาแดง น้ำตาไหลทั้งสองข้าง", presentIllness: "เริ่มมีอาการตาแดง 3 วันก่อน น้ำตาไหลมากขึ้น ขยี้ตาบ่อย" },
    ...
    visits: [
      {
        ...
        room: "ห้อง 1 — ทั่วไป", doctor: "สพ.ว. สมชาย",
        vitals: { temp: "38.7°C", pulse: "90 bpm", resp: "20 ครั้ง/นาที", weight: "32.0 กก.", chiefComplaint: "มาฉีดวัคซีน DHPP ประจำปี", presentIllness: "สุขภาพแข็งแรง ไม่มีอาการผิดปกติ" },
    ...
    visits: [
      {
        ...
        vitals: { temp: "38.6°C", pulse: "130 bpm", resp: "26 ครั้ง/นาที", weight: "3.8 กก.", chiefComplaint: "คันตามตัว ขนร่วง", presentIllness: "เริ่มมีอาการคัน 2 สัปดาห์ ขนร่วงบริเวณหลังและขาหลัง เกาจนเป็นแผล" },
