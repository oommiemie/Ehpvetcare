...
const dict: Record<string, Record<Lang, string>> = {
  ...
  "ipd.tab.io":          { th: "เฝ้าระวัง & I/O",        en: "Monitoring & I/O" },
  "ipd.tab.diet":        { th: "Diet Plan",              en: "Diet Plan" },
  "ipd.tab.lab":         { th: "Lab",                    en: "Lab" },
  "ipd.tab.xray":        { th: "Medical Imaging",                  en: "Medical Imaging" },
  ...
  /* กลุ่มตั้งค่าระบบ — รวมการแจ้งเตือน/การแสดงผล และตั้งค่าอื่นที่จะเพิ่มภายหลัง */
  "settings.tab.notify": { th: "ตั้งค่าระบบ",            en: "System settings" },
  ...
  "settings.sub.notifyDesc": { th: "นัดหมาย · สต๊อก · วันหมดอายุ", en: "Appointments · Stock · Expiry" },
  "settings.sub.displayDesc": { th: "ธีมสี · ตัวอักษร · เมนู · พื้นหลัง", en: "Theme · Text · Menu · Wallpaper" },
  ...
  "opd.tab.lab":            { th: "แล็บ",                                  en: "Lab" },
  "opd.tab.imaging":        { th: "Medical Imaging",                       en: "Medical Imaging" },
